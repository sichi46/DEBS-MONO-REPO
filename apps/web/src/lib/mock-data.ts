...
export const mockPolicies: Policy[] = [
    {
        ...
        endDate: "Jan 15, 2034",
        description: "Comprehensive life insurance coverage with death benefits and critical illness cover.",
    },
    {
        ...
        endDate: "Mar 1, 2025",
        description: "Full health coverage including hospitalization, outpatient care, and prescription drugs.",
    },
    {
        ...
        endDate: "—",
        description: "Comprehensive auto insurance covering collision, theft, and third-party liability.",
    },
];
...
export const mockClaims: Claim[] = [
    ...
    },
    {
        ...
        description: "Minor fender bender claim - rejected due to policy not yet active.",
    },
    {
...
export const mockBeneficiaries: Record<string, Beneficiary[]> = {
    "LP-2024-001234": [
        { id: "ben-001", name: "Mary Mwape", relationship: "Spouse", percentage: 60 },
        { id: "ben-002", name: "James Mwape", relationship: "Son", percentage: 40 },
    ],
    "HI-2024-005678": [
        { id: "ben-003", name: "John Mwape", relationship: "Self", percentage: 100 },
    ],
};
...
export const mockPaymentHistory: PaymentRecord[] = [
    { id: "pay-001", date: "Oct 1, 2025", amount: "ZMW 1,200", status: "Paid", method: "Mobile Money", policyNumber: "LP-2024-001234" },
    { id: "pay-002", date: "Oct 1, 2025", amount: "ZMW 850", status: "Paid", method: "Bank Transfer", policyNumber: "HI-2024-005678" },
    { id: "pay-003", date: "Sep 1, 2025", amount: "ZMW 1,200", status: "Paid", method: "Mobile Money", policyNumber: "LP-2024-001234" },
    { id: "pay-004", date: "Sep 1, 2025", amount: "ZMW 850", status: "Paid", method: "Card", policyNumber: "HI-2024-005678" },
    { id: "pay-005", date: "Aug 1, 2025", amount: "ZMW 1,200", status: "Paid", method: "Mobile Money", policyNumber: "LP-2024-001234" },
    { id: "pay-006", date: "Aug 1, 2025", amount: "ZMW 850", status: "Paid", method: "Bank Transfer", policyNumber: "HI-2024-005678" },
    { id: "pay-007", date: "Jul 1, 2025", amount: "ZMW 1,200", status: "Paid", method: "Mobile Money", policyNumber: "LP-2024-001234" },
    { id: "pay-008", date: "Jul 1, 2025", amount: "ZMW 850", status: "Paid", method: "Card", policyNumber: "HI-2024-005678" },
];
...
export const mockAvailablePolicies: AvailablePolicy[] = [
    {
        ...
        type: "Auto Insurance",
        icon: "🚗",
        description: "Comprehensive coverage for your vehicle including collision, theft, and liability.",
    ...
    },
    {
        ...
        icon: "✈️",
        description: "Coverage for trip cancellation, medical emergencies, and lost luggage.",
    ...
    },
    {
        ...
        icon: "💼",
        description: "Comprehensive protection for your business assets and liability.",
...
export function getPaymentHistoryForPolicy(policyNumber: string): PaymentRecord[] {
...
export const mockMonthlyData: MonthlyData[] = [
    ...
    { month: "Mar", revenue: 248000, payouts: 78000, newPolicies: 32, claims: 10 },
    { month: "Apr", revenue: 255000, payouts: 105000, newPolicies: 26, claims: 12 },
    ...
    { month: "Jul", revenue: 280000, payouts: 110000, newPolicies: 29, claims: 11 },
    { month: "Aug", revenue: 285000, payouts: 125000, newPolicies: 33, claims: 8 },
    { month: "Sep", revenue: 290000, payouts: 98000, newPolicies: 31, claims: 10 },
    { month: "Oct", revenue: 285000, payouts: 125000, newPolicies: 28, claims: 8 },
];
...
export const mockAllPayments: AdminPayment[] = [
    ...mockPaymentHistory.map(p => ({
        ...
        userId: "usr-001",
        userName: "John Mwape",
        policyType: p.policyNumber.startsWith("LP") ? "Life Insurance" :
                    p.policyNumber.startsWith("HI") ? "Health Insurance" : "Auto Insurance",
    })),
    {
        id: "pay-009",
        date: "Oct 1, 2025",
