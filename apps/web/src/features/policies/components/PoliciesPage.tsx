                    ...
                    <CardContent className="pt-6">
                        <div className="space-y-1">
                            ...
                            <p className="text-3xl font-bold">
                                {isLoading ? <Skeleton className="h-9 w-8" /> : policies?.length || 0}
                            </p>
                        </div>
                    </CardContent>
                </Card>
                    ...
                    <CardContent className="pt-6">
                        <div className="space-y-1">
                            ...
                            <p className="text-3xl font-bold text-success">
                                {isLoading ? <Skeleton className="h-9 w-8" /> : activePolicies.length}
                            </p>
                        </div>
                    </CardContent>
                </Card>
                    ...
                    <CardContent className="pt-6">
                        <div className="space-y-1">
                            ...
                            <p className="text-3xl font-bold text-warning">
                                {isLoading ? <Skeleton className="h-9 w-8" /> : pendingPolicies.length}
                            </p>
                        </div>
                    </CardContent>
                </Card>
                                ...
                                >
                                    ...
                                    <div className="flex items-center gap-4">
                                        ...
                                        <div className="min-w-0">
                                            <p className="font-semibold truncate">{policy.policyType}</p>
