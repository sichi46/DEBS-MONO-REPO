...
import type { PolicyStatus, PaymentStatus } from "../types";
...
export function PolicyDetailsPage() {
    ...
    const { data: policy, isLoading, error } = usePolicyDetails(policyNumber || "");
                            ...
                            {policy.beneficiaries.map((beneficiary) => (
                                ...
                                >
                                    ...
                                    <div className="text-right">
                                        <p className="text-lg font-semibold">{beneficiary.percentage}%</p>
