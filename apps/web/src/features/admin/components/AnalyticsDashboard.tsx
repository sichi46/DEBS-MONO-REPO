        ...
        <div className="space-y-6" data-testid="analytics-dashboard">
            ...
            <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
                ...
                <StatCard
                    ...
                    changeType="increase"
                    icon={FileText}
                    description={`${stats.totalPolicies} total`}
                />
                <StatCard
                        ...
                        <div className="h-[300px]">
                            <ResponsiveContainer width="100%" height="100%">
                                <AreaChart data={mockMonthlyData}>
                                    ...
                                    />
                                    <Tooltip
                                        formatter={(value: number) => [`ZMW ${value.toLocaleString()}`, ""]}
                                        contentStyle={{
                ...
                <Card>
                    ...
                    <CardContent>
                            ...
                            <ResponsiveContainer width="100%" height="100%">
                                <PieChart>
                                    <Pie
                                        ...
                                        dataKey="count"
                                    >
                                        {mockPolicyDistribution.map((entry, index) => (
                        ...
                        <div className="mt-4 space-y-2">
                            {mockPolicyDistribution.map((item) => (
                ...
                <Card>
                    <CardContent className="p-6">
                        <div className="space-y-1">
                            ...
                            <p className="text-2xl font-bold text-warning">{stats.totalPayouts}</p>
                        </div>
                    </CardContent>
                </Card>
                <Card>
