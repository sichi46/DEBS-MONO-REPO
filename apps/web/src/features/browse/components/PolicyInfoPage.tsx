            ...
            <Card>
                ...
                <CardContent>
                    ...
                    <p className="mt-4 text-muted-foreground">
                        DEBS Insurance provides comprehensive {policy.type.toLowerCase()} coverage
                        designed to protect you and your loved ones. Our policies are tailored to
                        meet your specific needs with competitive premiums and extensive coverage options.
                    </p>
                </CardContent>
            </Card>
                ...
                <CardContent>
                    <div className="grid gap-4 sm:grid-cols-3">
                        <div className="rounded-lg border p-4">
                            ...
                            <p className="text-sm text-muted-foreground">Essential coverage</p>
                        </div>
                        <div className="rounded-lg border-2 border-primary bg-primary/5 p-4">
                            <div className="mb-1 text-xs font-semibold text-primary">POPULAR</div>
                            <h4 className="font-semibold">Standard</h4>
                            <p className="mt-1 text-2xl font-bold text-primary">
                                ZMW {parseInt(policy.startingPremium.replace(/\D/g, "")) * 1.5}/mo
                            </p>
